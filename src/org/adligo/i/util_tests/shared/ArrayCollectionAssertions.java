...
import org.adligo.i.util_tests.ArrayCollectionTests;
import org.adligo.i.util_tests.GCTracker;
import org.adligo.i.util_tests.shared.mocks.MockString;
import org.adligo.tests.shared.AAssertions;

public class ArrayCollectionAssertions extends AAssertions {
	...
	public void addRemoveAndClearAsserts() {
	...
	public void memoryRepeaterAsserts() {
		/*
	...
	public void chunkSize10Asserts() {
		if (log.isDebugEnabled()) {
